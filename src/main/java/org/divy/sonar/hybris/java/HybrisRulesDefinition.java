 ...
 */
public class HybrisRulesDefinition implements RulesDefinition {

  // don't change that because the path is hard coded in CheckVerifier
  private static final String RESOURCE_BASE_PATH = "/org/sonar/l10n/java/rules/squid";

  public static final String REPOSITORY_KEY = "org.divy.sonar.hybris";
  ...
  private void addMetadata(NewRule rule, String metadataKey) {
    URL resource = HybrisRulesDefinition.class.getResource(RESOURCE_BASE_PATH + "/" + metadataKey + "_java.json");
    if (resource != null) {
  ...
  private static void addHtmlDescription(NewRule rule, String metadataKey) {
    URL resource = HybrisRulesDefinition.class.getResource(RESOURCE_BASE_PATH + "/" + metadataKey + "_java.html");
    if (resource != null) {
