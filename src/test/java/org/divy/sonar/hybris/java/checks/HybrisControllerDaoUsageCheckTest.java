...
public class HybrisControllerDaoUsageCheckTest {
  ...
  public void checkDaoUsage() {
    JavaCheckVerifier.verify("src/test/files/controller/HybrisControllerDaoUsage.java", new HybrisControllerDaoUsageCheck());
  }

  @Test
  public void checkHtmlUsage() {
    JavaCheckVerifier.verify("src/test/files/HybrisControllerModelUsageCheckTest.java", new HybrisControllerModelUsageCheck());
  }
}
